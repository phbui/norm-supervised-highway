...
class LaneChangeTailgatingNorm(TailgatingNorm):
    ...
    def is_violating_action(self, vehicle: MDPVehicle, action: Action) -> bool:
        ...
        return (super().evaluate_criterion(vehicle, action, next_lane_index, False) < safe_distance
                or super().evaluate_criterion(vehicle, action, next_lane_index, True) < safe_distance)
