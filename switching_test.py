    ...
    def default_config(cls) -> dict:
        ...
        config.update({
            ...
            "vehicle_positions": [
                ...
                {"lane": 1, "position": 50, "speed": 22, "vehicle_type": "slow_car"},
...
def main():
    ...
    with open("results.txt", "a") as f:
        ...
        f.write(f"Scenario: Chess board traffic pattern forcing frequent lane switching\n")
        f.write(f"Lanes: {env_config['lanes_count']}\n")
        f.write(f"Vehicles: {len(env_config.get('vehicle_positions', []))}\n")
